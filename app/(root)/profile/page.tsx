  ...
  return (
    <>
      ...
      <div className="bg-gray-100 h-screen">
        ...
        flex items-start justify-between h-56 grid grid-cols-2 gap-4
        content-start
        <div className="flex items-start bg-blue-700 h-50 justify-between grid grid-cols-2 gap-4 content-start">
